**Note:** Issues in this repository are reserved for feature requests only. Bugs should be reported in the main [Meteor repo issue tracker](https://github.com/meteor/meteor).
